...
//                .filter(new PredicatGenreHomme());
    ...
    @FunctionalInterface interface FunctionNom extends Function<Employe, String > {
    }
    ...
    @FunctionalInterface interface ConsumerForEach extends Consumer<Employe> {
    }
    ...
    private static void exForEach(){
        employes.forEach(new ConsumerForEach() {
            @Override
